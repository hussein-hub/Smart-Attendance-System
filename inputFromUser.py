...
def checkCSV(self,controller,dict1):
     flag = True
     print(dict1)
     ...
     if not markAttendance.checkDatabase():
         ...
         # creating new CSV
         df.to_csv(file)
         autogeneratedEmail.send_email('Attendance', f'For {fileName[0]} year, subject {fileName[2:]}', fileName)
         #     print("Error")
         # print("Mail CSV")
...
class selectSubject(tk.Frame):
    def __init__(self, parent, controller):
        ...
        create = tk.Button(self,text='Send Attendance', command=lambda: checkCSV(self,controller,currentLecture), bg='#accdf5')
